...
MODEL_NAME=CoMP-MM-1B-DINOv2/stage1
...
bash scripts/slimm/job_template.sh $MODEL_NAME $DATA_PATH  \
    ...
    --custom_visual_model SliMM-X/Original-DINOv2-Large \
...
MODEL_NAME=CoMP-MM-1B-DINOv2/stage2x1
CKPT=checkpoints/$MODEL_NAME
...
PREV_CKPT=$CKPT
DATA_PATH=scripts/data/Stage-II.yaml
MODEL_NAME=CoMP-MM-1B-DINOv2/stage2x2
CKPT=checkpoints/$MODEL_NAME
